		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#ProyectN2employees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProyectN2employees-display": {
								"semanticObject": "ProyectN2employees",
								"action": "display",
								"description": "Proyecto 1 del nivel 2",
								"title": "Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ProyectN2.employees",
									"url": sap.ui.require.toUrl("ProyectN2/employees")
								}
							}
						}
					}
